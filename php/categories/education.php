...
<body>
    <div class="d-flex top-banner align-items-center">
        <div class="banner-text">
            <h1>EDUCATION</h1>
            <p>Break the barriers to education with your donation.</p>
        </div>
        <div class="float-right align-self-end">
            <img class="banner-img" src="../../resources/img/education-banner.png" alt="Education illustration">
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md px-5 py-2">
                <a href="#">
                    ...
                    <div class="project-list-fundraiser">Fundraiser: Bunway</div>
                    <div class="project-list-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum a distinctio pariatur itaque fuga necessitatibus soluta, commodi cum laborum voluptatibus, in, aperiam voluptate? Eveniet dolores in ea amet, cupiditate at!</div>
                    <div class="d-inline-flex align-items-center">
                        <div class="project-list-funds-raised">RM 6900.69 raised</div>
                        <div class="project-list-funds-raised-total">&nbsp;of RM 100,000.00</div>
                    </div>
